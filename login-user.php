        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="login-user.php" method="POST" autocomplete="">
                    ...
                    <div class="link login-link text-center"><a href="signup-user.php">Signup now</a></div>
                    <div class="link login-link text-center"><a href="adminlogin.php">Admin Login</a></div>
                </form>
            </div>
        </div>
    </div>
